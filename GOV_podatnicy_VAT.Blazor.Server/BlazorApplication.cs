...
using GOV_podatnicy_VAT.Blazor.Server.Services;

namespace GOV_podatnicy_VAT.Blazor.Server {
    public partial class GOV_podatnicy_VATBlazorApplication : BlazorApplication {
        public GOV_podatnicy_VATBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void GOV_podatnicy_VATBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
